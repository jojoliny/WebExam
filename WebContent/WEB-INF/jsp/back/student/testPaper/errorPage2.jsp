...
<!--页码  -->
			...
			<nav aria-label="Page navigation">
			  ...
			  <!-- 上一页 -->
			    ...
			    ">
			      <a href="${ctx }/QuestionServlet?method=toListErrorUI&pageIndex=${pages.pageIndex -1}" aria-label="Previous">
			    ...
			    <c:forEach begin="1" end="${pages.getTotalIndex() }"  varStatus="vs">
			    	<c:if test="${ vs.count == pages.pageIndex}">
			    		<li class="active "><a  href="${ctx }/QuestionServlet?method=toListErrorUI&pageIndex=${ vs.count}">${ vs.count}</a></li>
			    	</c:if>
			    	
			    	<c:if test="${ vs.count != pages.pageIndex}">
			    		<li><a href="${ctx }/QuestionServlet?method=toListErrorUI&pageIndex=${ vs.count}">${ vs.count}</a></li>
			    	</c:if>
			    </c:forEach>
			    ...
			    ">
			      <a href="${ctx }/QuestionServlet?method=toListErrorUI&pageIndex=${pages.pageIndex +1}" aria-label="Next">
