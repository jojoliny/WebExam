					...
					<div class="test_title">
						...
						<div class="test_content">
							<div class="test_content_title">
								...
								<h2>错题本</h2>
								<p>
									<span>共</span><i class="content_lit">${totalSize}</i><span>题，</span><span>每题</span><i class="content_fs">5</i><span>分</span>
								</p>
							</div>
						</div>
						<%int num=0; %>
				<c:forEach items="${realQuestionAndAnswer}" var="item" varStatus="vs">
								...
								<!--题目-->
									<li id="qu_0_0">
										...
										<div class="test_content_nr_tt">
											<i>${vs.count}</i><span>(5分)</span><font>${item.questions}（  <span style="color: #E21737;">${item.answer}</span>）</font><b class="icon iconfont"></b>
										</div>
