						...
						<div class="container-fluid">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<ul class="nav navbar-nav">
									...
									<li><a href="${ctx }/StudentServlet?method=personalUI">个人中心</a></li>
									<li><a href="${ctx }/StudentServlet?method=loginUI">登录系统</a></li>
									<li class="active"><a href="${ctx }/StudentServlet?method=logoutUI">注销系统</a></li>
								</ul>
							</div>
						</div>
					</nav>
